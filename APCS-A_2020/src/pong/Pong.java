...
public class Pong extends Canvas implements KeyListener, Runnable {
	...
	public Pong() {
		...
		walls.add(new Wall(0, 10, 0, 600, Color.black));
		walls.add(new Wall(790, 800, 0, 600, Color.black));
		walls.add(new Wall(10, 790, 0, 10, Color.black));
		walls.add(new Wall(10, 790, 590, 600, Color.black));
		leftPaddle = new Paddle(20, 270, 10, 45, Color.magenta, 3);
		rightPaddle = new Paddle(770, 270, 10, 45, Color.magenta, 3);
		ball = new InvisibleBall(400, 300, 10, 10, Color.orange, -3, 0);
