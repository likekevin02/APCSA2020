...
public class CelebrityFrame extends JFrame {
	...
	/**
	 * A reference to the CelebrityGame instance to allow for minimized coupling in
	 * the object structure.
	 */
	private CelebrityGame controller;

	/**
	 * Builds an instance of the CelebFrame with a reference to the CelebrityGame
	 * instance.
	 * 
	 * @param controller A reference to a CelebrityGame to share with the CelebPanel
	 *                   instance.
	 */
	public CelebrityFrame(CelebrityGame controllerRef) {
		// The first line of any subclass should ALWAYS be a correct call to the super
		// constructor.
		super();
