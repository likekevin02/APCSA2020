...
/**
 * Subclass of Celebrity to show how methods can be overridden and super can be
...
public class LiteratureCelebrity extends Celebrity {
	/**
	 * The list of clues for the Literature Celebrity. They can be titles of texts,
	 * important characters, settings, etc...s
	 */
	private ArrayList<String> clueList;

	/**
	 * Builds a LiteratureCelebrity instance with an answer and a series of clues as
	...
	/**
	 * Processes the series of clues for the LiteratureCelebrity by adding all the
	 * values to an ArrayList<String> by splitting the original clue to an array of
	 * String. The original value is not impacted, thus preserving data and
